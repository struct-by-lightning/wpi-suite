...
public class AddPlanningPokerVoteController{
	...
	/**
	 * Construct an AddPlanningPokerVoteController for the given model, view pair
	 ...
	 * @return the instance of the AddPlanningPokerVoteController or creates one if it does not
	 * exist. */
	 ...
	 * @param newPlanningPokerVote is the PlanningPokerVote to be added to the server.
	 */
