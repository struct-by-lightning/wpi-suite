...
public class AddPlanningPokerGameController{
	...
	/**
	 * Construct an AddPlanningPokerGameController for the given model, view pair
	 ...
	 * @return the instance of the AddPlanningPokerGameController or creates one if it does not
	 * exist. */
