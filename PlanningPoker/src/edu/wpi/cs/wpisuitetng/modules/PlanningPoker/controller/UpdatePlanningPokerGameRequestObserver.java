...
public class UpdatePlanningPokerGameRequestObserver implements RequestObserver {
	...
	private final UpdatePlanningPokerGameController controller;
	 ...
	 */
	public UpdatePlanningPokerGameRequestObserver(UpdatePlanningPokerGameController controller) {
	...
	public void responseError(IRequest iReq) {
		...
		System.err.println("The request to update a PlanningPokerGame failed.");
	}
