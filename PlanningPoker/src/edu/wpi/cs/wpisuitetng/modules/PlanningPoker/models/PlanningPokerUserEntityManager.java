...
public class PlanningPokerUserEntityManager implements EntityManager<PlanningPokerUser> {
	...
	public PlanningPokerUser[] getAll(Session s) throws WPISuiteException {
		...
		ret = data.retrieveAll(new PlanningPokerUser(null, null, null, null, false, false, false)).toArray(ret);
		return ret;
	}
	...
	public void deleteAll(Session s) throws WPISuiteException {
		...
		data.deleteAll(new PlanningPokerUser(null, null, null, null, false, false, false));
