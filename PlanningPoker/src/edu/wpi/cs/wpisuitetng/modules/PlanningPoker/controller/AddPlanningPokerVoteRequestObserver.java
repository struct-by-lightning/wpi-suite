 ...
 * to the server to add a planning poker vote.
...
public class AddPlanningPokerVoteRequestObserver implements RequestObserver {
	 ...
	 * @param controller the controller used to add PlanningPokerVotes
	 */
	public AddPlanningPokerVoteRequestObserver(AddPlanningPokerVoteController controller) {
		this.controller = controller;
	}
	
	/**
	 * Parse the PlanningPokerVote that was received from the server then pass them to
	 * the controller.
	 * 
